...
| 2.2.4 | 新規登録ボタン | 「新規登録」ボタンクリック | アラート「開発中」が表示 | [✅] | 暫定対応 |
...
| # | 項目 | 手順 | 期待結果 | 結果 | 備考 |
|---|------|------|----------|------|------|
| 2.3.1 | ページ表示 | 左メニュー「システム設定」クリック | 設定フォームが表示 | [✅] | |
| 2.3.2 | 外部API設定表示 | e-Stat API設定確認 | 入力フィールドが表示 | [✅] | |
| 2.3.3 | 保存ボタン | 「保存」ボタンクリック | 成功メッセージが表示 | [❌] | |
